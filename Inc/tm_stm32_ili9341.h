...
RST		Pd8		Reset LCD
CS		Pd9		Chip select for SPI
WRX 	Pd10	(D/C)	Data/Command register
SCL		Pa5		SPI clock
MISO	Pa6 	Output from LCD for SPI.	Not used, can be left
MOSI	Pa7		SPI master output
LED		3V3		Backlight
VCC		3V3		Positive power supply
GND		GND		Ground
...
void pictureP50(uint16_t posx, uint16_t posy);
