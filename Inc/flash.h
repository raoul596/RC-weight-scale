...
#define FLASH_APP_START_ADDR		ADDR_FLASH_PAGE_16 /* Start @ of user Flash area */
#define FLASH_SHADOW_START_ADDR		ADDR_FLASH_PAGE_72 /* Start @ of shadow Flash area */
#define APP_SIZE					(ADDR_FLASH_PAGE_71 - ADDR_FLASH_PAGE_16)
#define SHADOW_SIZE					(ADDR_FLASH_PAGE_126 - ADDR_FLASH_PAGE_71)
